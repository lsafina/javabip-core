package org.javabip.spec.demo;

import org.javabip.annotations.*;
import org.javabip.api.DataOut;
import org.javabip.api.PortType;

import static org.javabip.spec.demo.Coin.HEADS;
import static org.javabip.spec.demo.Coin.TAILS;
import static org.javabip.spec.demo.Constants.*;
@Ports({
...
public class Casino {
    ...
    // Add money to pot
    @Transitions({
        @Transition(name = ADD_TO_POT, source = IDLE, target = IDLE, guard = IS_OPERATOR, requires = "funds >= 0" /* TODO: added later! */),
