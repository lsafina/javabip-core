...
public class boolParser extends Parser {
    ...
    public static class IdentContext extends ParserRuleContext {
        ...
        public TerminalNode ID() {
            return getToken(boolParser.ID, 0);
        }

        public TerminalNode LPAREN() {
            return getToken(boolParser.LPAREN, 0);
        }

        public TerminalNode RPAREN() {
            return getToken(boolParser.RPAREN, 0);
        }
    ...
    public static class TermContext extends ParserRuleContext {
        ...
        public TerminalNode NEGATION() {
            return getToken(boolParser.NEGATION, 0);
        }
    ...
    public static class ManomContext extends ParserRuleContext {
        ...
        public TerminalNode INTERSECTION() {
            return getToken(boolParser.INTERSECTION, 0);
        }
    ...
    public static class Expr_innerContext extends ParserRuleContext {
        ...
        public TerminalNode UNION() {
            return getToken(boolParser.UNION, 0);
        }
